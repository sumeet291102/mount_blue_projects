...
let get_info = (board_name, list1_name, list2_name) => {
    ...
    if(board_name === undefined || list1_name === undefined || list2_name === undefined) {
        ...
        if(lists[board_id] === undefined) {
            ...
            get_the_board_with_board_id(board_id, (data) => {
                console.log(data);
            
                get_all_the_lists_of_board_id(board_id, (data) => {
                    console.log(data);
            
                    get_all_the_cards_of_list_id(list1_id, (data) => {
                        console.log(data);
                    })
        
                    get_all_the_cards_of_list_id(list2_id, (data) => {
                        console.log(data);
                    })
                })
            })
